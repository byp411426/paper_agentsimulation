...
2026-09-12 更新：下文描述 9 月 10 日单次运行的执行方式。家庭协议修复、双向共识核验及另行运行的固定场景检查见[最新说明](household_process_validation_20260912.md)。原运行的第五项保留当时状态，新版本的固定场景结果独立报告，不能拼进旧运行冒充同一批实验。
