"""Audit r7 batches through the frozen v8 summarizer without renaming data."""
...
DEFAULT_OUTPUT = DEFAULT_RESULTS / "carr_s_e2_v8_formal_r7_cumulative_summary.json"
...
def main() -> None:
    ...
    protocol_id = "carr_s_e2_v8_formal_r7"
    with tempfile.TemporaryDirectory(
        prefix="carr-e2-r7-audit-", dir=results_dir
    ) as temporary:
    ...
    if summary["completion"]["planned_runs"] != (
        ...
        raise ValueError("r7 audit planned-run count violates E2 contract")
    output.write_text(
